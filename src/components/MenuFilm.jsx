...
/* Menu film: second scroll-scrubbed stage. The 20s reel walks through
   espresso pulls, filter brewing and beans while each menu group's
   items gather over its part of the footage. Lazy: the film only
   starts downloading once the stage approaches the viewport. */
